# _[Queen Attack](https://github.com/TSiu88/queen-attack)_

#### _Find Valid Queen Chess Moves, 02.24.2020_

#### By _**Tiffany Siu and Jack Dunning**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/queen-attack)
![Languages](https://img.shields.io/github/languages/top/tsiu88/queen-attack)
...
This application is for the Epicodus Intro to Programming and C#/React Course.  It uses a coordinate system in the console and asks for the location of the queen and another coordinate on the board.  It will then tell user whether or not that is a valid move location for a queen in chess to attack another piece.
...
2. Clone the [repository](https://github.com/TSiu88/queen-attack.git) from my [GitHub page](https://github.com/TSiu88)
